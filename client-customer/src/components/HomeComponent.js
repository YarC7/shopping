...
import bugati from "../images/bugati.jpg"
 ...
 const reviews = [
  {
    ...
    rating: 5,
    comment: "Hiệu suất của nó thực sự đáng kinh ngạc và cảm giác tiếp xúc với đường là điều tuyệt vời nhất. Thiết kế ngoại thất rất ấn tượng và nó thực sự nổi bật giữa đám đông.",
    profileImage:profile1,
  },
  {
    customerName: "Nguyễn Đức Cảnh",
    rating: 4,
    comment: "Đây là một trải nghiệm khác biệt hoàn toàn so với bất kỳ chiếc xe thông thường nào. Hiệu suất vượt trội, động cơ phản lực và âm thanh ma mị của động cơ khiến tôi thực sự say đắm.",
    profileImage:profile3,
  },
  {
    customerName: "Bé Na",
    rating: 5,
    comment: "Nó không chỉ nhanh mạnh mẽ mà còn mang đến cảm giác an toàn và kiểm soát tốt khi lái ở tốc độ cao.",
 ...
 return (
      <div className="home-container">
        {loading ? (
          ...
          <Carousel autoPlay infiniteLoop showThumbs={false}>
            <div>
              <img src={bugati} alt="Slide 1" className="carousel-image" />
            </div>
            <div>
              <img src={ferrari} alt="Slide 2" className="carousel-image" />
            </div>
            <div>
              <img src={lambo} alt="Slide 3" className="carousel-image" />
            </div>
          </Carousel>
        )}
