    ...
    return (
      <div className="customer-container">
        <div className="align-center">
          <h2 className="customer-header">DANH SÁCH KHÁCH HÀNG</h2>
        ...
        {orders.length > 0 && (
          <div className="order-list-container">
            <h2 className="order-header">DANH SÁCH ĐẶT HÀNG</h2>
            <Table celled className="datatable">
              <Table.Header>
                <Table.Row className="datatable">
                  <Table.HeaderCell>ID</Table.HeaderCell>
                  ...
                  <Table.HeaderCell>Tổng Đơn Hàng</Table.HeaderCell>
        ...
        {order && (
          <div className="order-detail-container">
            <h2 className="order-detail-header">CHI TIẾT ĐƠN HÀNG</h2>
            <Table celled className="datatable">
              <Table.Header>
                <Table.Row className="datatable">
                  <Table.HeaderCell>STT</Table.HeaderCell>
                  <Table.HeaderCell>Mã Đơn Hàng</Table.HeaderCell>
                  <Table.HeaderCell>Tên Đơn Hàng</Table.HeaderCell>
